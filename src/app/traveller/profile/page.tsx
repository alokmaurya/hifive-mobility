        ...
        <div className="bg-blue-950 px-4 pt-10 pb-4">
          <div className="max-w-md mx-auto flex items-center justify-between">
            <div>
              ...
              <p className="text-blue-300 text-sm mt-0.5">Manage your account</p>
            </div>
            <button
              onClick={handleSignOut}
              className="flex items-center gap-1.5 text-blue-300 hover:text-red-400 transition-colors text-sm"
            >
          ...
          {loading ? (
            ...
            <>
              ...
              <div className="flex flex-col items-center mb-6">
                <div className="w-20 h-20 bg-sky-100 rounded-full flex items-center justify-center border-2 border-sky-200">
                  <UserCircle className="w-12 h-12 text-sky-400" />
                </div>
                <p className="text-blue-900 font-bold mt-2">{traveller?.name || "Traveller"}</p>
              ...
              <div className="bg-white rounded-3xl p-5 border border-sky-200 shadow-sm">
                <h2 className="text-blue-900 font-semibold text-sm mb-4">Edit Details</h2>
                <form onSubmit={handleSave} className="space-y-4">
                  ...
                  <div>
                    <label className="text-xs font-semibold text-blue-700 uppercase tracking-wide block mb-1.5">Phone</label>
                    <input
                      type="tel"
                      value={phone}
                  ...
                  <button
                    type="submit"
                    disabled={saving}
                    className="w-full py-3 bg-sky-500 text-white font-bold rounded-2xl hover:bg-sky-400 disabled:opacity-50 transition-colors flex items-center justify-center gap-2 text-sm"
                  >
