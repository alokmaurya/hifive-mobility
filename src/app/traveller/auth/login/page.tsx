...
import { MapPin, Eye, EyeOff, Star } from "lucide-react";
    ...
    <div className="min-h-screen flex flex-col lg:flex-row">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative bg-slate-900 overflow-hidden flex-col">
        ...
        <div className="relative z-10 p-8 flex items-center gap-3">
          ...
          <span className="text-white font-extrabold text-lg tracking-tight">HiFive Tours</span>
        </div>
        ...
        <div className="relative z-10 flex-1 flex flex-col justify-center px-8 pb-8 gap-4">
          <div className="mb-2">
            ...
            <p className="text-slate-400 text-sm mt-2">Book local expert drivers for unforgettable journeys</p>
          </div>
          ...
          <div className="bg-white/5 border border-white/10 rounded-2xl p-4 mt-1">
            ...
            <p className="text-slate-300 text-xs leading-relaxed italic">
              &ldquo;The best way to discover India! Our driver knew every hidden gem in Jaipur.&rdquo;
            </p>
            <p className="text-slate-500 text-xs mt-2">— Priya S., Mumbai</p>
          </div>
        </div>
      </div>
      ...
      <div className="flex-1 lg:w-1/2 flex flex-col bg-slate-50">
        ...
        {/* Form area */}
        <div className="flex-1 flex items-center justify-center px-6 py-10 lg:-mt-0 -mt-6">
          <div className="w-full max-w-sm">
            {/* Desktop brand shown inside right panel */}
            <div className="hidden lg:block mb-8">
              <h2 className="text-3xl font-extrabold text-slate-900">Welcome back 👋</h2>
              <p className="text-slate-400 text-sm mt-1">Sign in to explore tours across India</p>
            </div>
            ...
            <div className="bg-white rounded-3xl shadow-xl border border-slate-100 p-6">
              ...
              <div className="lg:hidden mb-5">
                ...
                <p className="text-slate-400 text-sm mt-0.5">Sign in to explore tours</p>
              </div>
